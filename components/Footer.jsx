...
const Footer = () => {
  return (
    <footer className="w-full bg-red-600 m-0 p-0">
      ...
      <div className="bottom_footer text-[12px] md:flex flex-col md:justify-between justify-center items-center mx-auto px-5 text-white/[0.5] max-w-[1280px] bg-red-600 pb-3  flex-wrap text-center">
        <div className="copy_rights text-center">
          &copy;2023 Wal-Cart Inc Alrights Resevere Created by Dil Food Pvt Ltd.
        </div>
